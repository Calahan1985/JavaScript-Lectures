...
// $("img").on("mousedown", null, "It's mousedown event", 
// function (e) {
	// e.preventDefault();
	// console.log(e.data);
...
var newElem = $("<div class='universalWrapper' />").on("click", function () {
...
//$("span", $test).remove();
// $("span", $test).remove(".one"); //only the first span has been removed
// $test.remove();
...
// $("ul", $test).on("click", function () {alert("Error!")});
